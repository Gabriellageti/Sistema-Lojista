    ...
    <header className="hs-header sticky top-0 z-50 w-full border-b px-4 py-3">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h1 className="text-lg font-bold">{branding.storeName}</h1>
            <p className="text-xs opacity-90">{branding.slogan}</p>
          </div>
        </div>
          ...
          <SheetContent side="right" className="w-72">
            <div className="flex flex-col gap-4 mt-8">
              <div className="flex items-center gap-3 pb-4 border-b">
                ...
                />
                <div>
                  <h2 className="font-bold text-lg">{branding.storeName}</h2>
